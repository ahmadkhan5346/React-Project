    ...
    const handleSubmit = (event) => {
        ...
        if (actualData.password && actualData.password_confirmation) {
            if (actualData.password === actualData.password_confirmation) {
                ...
                setError({
                    status: true, msg: "Password Changed Successfully", type: 'success'
                })
            } else {
                setError({
    ...
    return <>
        <Box sx={{ display: 'flex', flexDirection: 'column', flexWrap: 'wrap', maxWidth: 600, mx: 4 }}>
            ...
            <Box component="form" onSubmit={handleSubmit} noValidate sx={{mt: 1}} id="password-change-form">
                ...
                <TextField margin="normal" required fullWidth name="password_confirmation" label="Confirm New Password" type="password" />
